			...
			<Wrapper>
				<div className='flex flex-col lg:flex-row md:px-10 gap-[50px] lg:gap-[100px]'>
					...
					<div className='flex-[1] py-3'>
						...
						<div className='text-md font-edium text-black/[0.5] mb-20'>
						...
						<button className='w-full py-4 rounded-full border border-black text-lg font-medium transition-transform active:scale-95 flex items-center justify-center gap-2 hover:opactiy-75 mb-10'>
							Wishlist
